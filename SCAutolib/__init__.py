...
def run(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE, check=True,
    ...
    and performing robust error checking based on expected return codes.
    ...
    :param stdout: Redirects the standard output of the command. Defaults to
                   ``subprocess.PIPE`` to capture output.
    :type stdout: None or int or IO
    :param stderr: Redirects the standard error of the command. Defaults to
                   ``subprocess.PIPE`` to capture output.
