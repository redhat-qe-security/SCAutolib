...
class Controller:
    ...
    def prepare(self, force: bool, gdm: bool, install_missing: bool,
        ...
        :param force: A boolean flag. If ``True``, existing objects, files,
                      users, or services will be erased or overwritten if they
                      already exist. Its exact meaning can vary slightly for
                      different internal methods.
        :type force: bool
        :param install_missing: A boolean flag. If ``True``, all detected
                                missing prerequisite packages will be
                                automatically installed.
        :type install_missing: bool
        :param gdm: A boolean flag. If ``True``, the
                    GDM (GNOME Display Manager) package will be installed as
                    part of system preparation.
        :type gdm: bool
        :param graphical: A boolean flag. If ``True``, dependencies
                          specifically required for GUI testing will be
                          installed.
        :type graphical: bool
        :return: None
    ...
    def setup_graphical(self, install_missing: bool, gdm: bool):
        ...
        This involves installing necessary graphical packages and ensuring
        the environment is ready for GUI automation.
    ...
    def setup_local_ca(self, force: bool = False):
        ...
        :param force: A boolean flag. If ``True``, any existing local CA in the
    ...
    def setup_ipa_client(self, force: bool = False):
        ...
        :param force: A boolean flag. If ``True`` and an IPA Client is already
                      configured, the existing installation will be uninstalled
                      before setting up the new client.
        :type force: bool
        :return: None
    ...
    def setup_user(self, user_dict: dict, force: bool = False):
        ...
        :type user_dict: dict
        :param force: A boolean flag. If ``True``, the user (and associated
                      card directory if applicable) will be re-created,
                      deleting any existing user with the same name.
        :type force: bool
    ...
    def setup_card(self, card_dict: dict, force: bool = False):
        ...
        SoftHSM2 token and systemd service.

        :param card_dict: A dictionary containing the attributes of the card
                          to be created, such as 'name', 'pin', 'card_type',
                          etc.
        :type card_dict: dict
        :param force: A boolean flag. If ``True``, and the card's directory
                      already exists, it will be removed before creating the
                      new card. For virtual cards,
                      it also triggers revocation of existing certificates.
        :type force: bool
    ...
    def cleanup(self):
        ...
        IPA client CA setups. It also clears
        OpenSC and SSSD caches.
    ...
    def _validate_configuration(conf: dict, params: dict = None) -> dict:
        ...
        :type params: dict, optional
        :return: A dictionary containing the validated and potentially retyped
    ...
    def init_ca(self, local: bool = False):
        ...
        :param local: A boolean flag. If ``True``, a local CA is initialized.
