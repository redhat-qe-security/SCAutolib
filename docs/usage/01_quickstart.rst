...
the complexities of low-level smart card commands (APDU - Application Protocol
Data Unit) and cryptographic operations, allowing you to focus on defining and
executing your smart card test cases in an automated way. Think of it as a
toolkit that provides ready-to-use functions for common smart card testing
scenarios, such as:
...
* **Simplification:** Interact with complex smart card commands through simple,
  high-level Python functions. No need to craft APDUs manually!
...
.. note::
    ...
    This is a very simple example. The library hs many more capabilities
